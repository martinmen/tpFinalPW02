        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <button name="submit" class="btn btn-success btn-rounded btn-fw" style="float:left"><a style="color:white!important" href="vista_factura.php">Confimar Pago</a></button>
                </div>
            </div>
        </div>
    </div>
